...
public interface ReservationRepository extends JpaRepository<ReservationModel, Integer> {
    ...
    @Query(value = "select r.reservation_id,r.date,slot.start_time as TimeToCheckUp, r.total_reservation_price,r.status,r.fullname,r.gender,r.phone,r.email\n" +
            "from reservation r\n" +
            ...
            "group by r.reservation_id,r.date,slot.start_time, r.total_reservation_price,r.status,r.fullname,r.gender,r.phone,r.email ",nativeQuery = true)
